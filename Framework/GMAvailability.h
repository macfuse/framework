...
#define GM_MACFUSE_5_0 050000
  ...
  #if GM_VERSION_MIN_REQUIRED < GM_MACFUSE_5_0
    #define GM_AVAILABILITY_INTERNAL__5_0 GM_AVAILABILITY_WEAK
  #else
    #define GM_AVAILABILITY_INTERNAL__5_0
  #endif
